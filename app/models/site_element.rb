class SiteElement < ApplicationRecord
  ...
  validates :text_field_font_size, numericality: { only_integer: true, greater_than_or_equal_to: 0 }
  ...
  def fonts
    (headline.to_s + caption.to_s + link_text.to_s).scan(/font-family: "?(.*?)"?,/).flatten.uniq - SYSTEM_FONTS + [text_field_font_family]
  end
