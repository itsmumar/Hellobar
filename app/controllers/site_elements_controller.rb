class SiteElementsController < ApplicationController
  ...
  def site_element_params
    ...
    params.require(:site_element).permit(:rule_id, :element_subtype, :message, :background_color, :border_color, :button_color, :font, :link_color, :link_text, :text_color, :closable, :show_branding, :contact_list_id, :display_when, {:settings => settings_keys})
  end
end
