...
export default Ember.Component.extend({
  ...
  trackColorView: (function () {
    if (this.get('applicationSettings.settings.track_editor_flow') && !Ember.isEmpty(this.get('model'))) {
  ...
  }).observes('applicationSettings.settings', 'model').on('init'),
