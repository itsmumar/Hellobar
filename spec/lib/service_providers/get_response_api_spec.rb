    ...
    context '#subscribe' do
      it 'submits email address as name if name is not present' do
        ...
        expect(double_request).
          to receive(:body=).
          with({name: "Bob", email: "bobloblaw@lawblog.com", cycle_day: nil, campaign: {campaignId: 1122}}).
      ...
      it 'does not submit email address as name if name is present' do
        ...
        expect(double_request).
          to receive(:body=).
          with({name: "bobloblaw@lawblog.com", email: "bobloblaw@lawblog.com", cycle_day: nil, campaign: {campaignId: 1122}}).
          and_return(double_response)
