describe FetchSiteStatisticsByGoal do
  ...
  describe '#call', freeze: '2017-01-05' do
    let(:traffic) { create(:site_element_statistics_record, date: '2017-01-01', site_element: site_element_traffic) }
    let(:email) { create(:site_element_statistics_record, date: '2017-01-02', site_element: site_element_email) }
    let(:call) { create(:site_element_statistics_record, date: '2017-01-03', site_element: site_element_call) }
    let(:twitter) { create(:site_element_statistics_record, date: '2017-01-01', site_element: site_element_twitter) }
    let(:facebook) { create(:site_element_statistics_record, date: '2017-01-02', site_element: site_element_facebook) }
