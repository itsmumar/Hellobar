...
feature 'MailChimp Integration', :js, :contact_list_feature do
  ...
  context 'when invalid' do
    ...
    scenario 'displays error' do
      connect
      expect(page).to have_content('There was a problem connecting your MailChimp account')
    end
  end
  ...
  scenario 'when valid' do
    ...
    expect(page).to have_content 'Syncing contacts with MailChimp list "List 1"'
