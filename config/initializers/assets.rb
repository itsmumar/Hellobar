...
Rails.application.config.assets.precompile += %w[editor.css static.css auth.css admin.css editor/application.js ember.js *.css.erb *.css.sass.erb common-css common-js]
