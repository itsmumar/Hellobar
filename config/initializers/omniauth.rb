Rails.application.config.middleware.use OmniAuth::Builder do
  ...
  provider :google_oauth2, Hellobar::Settings[:google_auth_id], Hellobar::Settings[:google_auth_secret], access_type: "offline", scope: "email, profile, analytics.readonly, offline"
