Rails.application.routes.draw do
  ...
  # post "/users/:user_id/update_exit_intent", to: "exit_intent#update", as: :update_user_exit_intent
  resources :users do
    post :update_exit_intent, to: "user_campaign#update_exit_intent", as: :update_user_exit_intent
    post :update_upgrade_suggest, to: "user_campaign#update_upgrade_suggest", as: :update_user_upgrade_suggest
  end
