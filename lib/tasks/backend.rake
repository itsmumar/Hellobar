namespace :backend do
  ...
  task :adjust_dynamo_db_capacity, [:type] => :environment do |t, args|
    ...
    table_names.each do |table_name|
      ...
      if args[:type] != "throttled_only"or table[:recent_throttled_write].to_i > 50 or table[:recent_throttled_read].to_i > 50
