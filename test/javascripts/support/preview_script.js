...
HB_BACKEND_HOST = "edge-hi.hellobar.com";
...
if (Object.prototype.toString.call( _hbq ) === "[object Array]") {
  HB = _HB;
    HB.setTemplate("traffic", "<div id=\"hellobar\" class=\"{{bar.size}} {{bar.tab_side}} {{HB.t(bar.show_border) ? 'has_border' : ''}} {{HB.t(bar.remains_at_top) ? 'remains_at_top' : ''}}\" style=\"background-color: #{{bar.background_color}}; color: #{{bar.text_color}}; font-family: {{bar.font}}; border-color: #{{bar.border_color}};\">\n<div id=\"hb_msg_container\">\n  <span>\n    {{bar.message}}\n  </span>\n  <a onclick=\"window.parent.HB.trackClick(this); return false;\" class=\"hellobar_cta hb-{{bar.link_style}}\" href=\"{{bar.settings.url}}\" {{HB.t(bar.open_in_new_window) ? 'target=_blank' : 'target=_parent'}} style=\"color: #{{bar.link_color}}; background-color: #{{bar.button_color}}; border-color: #{{bar.button_color}}\">\n    {{bar.link_text}}\n  </a>\n</div>\n  <a href=\"http://www.hellobar.com/?utm_medium=hellobar&utm_campaign=HBlogo\" target=\"_parent\" class=\"hellobar_logo\"><img src=\"https://s3.amazonaws.com/hb-assets/logo_white.png\" alt=\"Hello Bar\" /></a>\n  <a href=\"#\" class=\"hellobar_arrow\" style=\"{{HB.t(bar.closable) ? '' : 'display:none'}}\"><img src=\"https://s3.amazonaws.com/hb-assets/arrow_white.png\" alt=\"\" /></a>\n  <div id=\"hellobar-shadow\"></div>\n</div>\n");
    HB.setTemplate("email", "<div id=\"hellobar\" class=\"{{bar.size}} {{bar.tab_side}} {{HB.t(bar.show_border) ? 'has_border' : ''}} {{HB.t(bar.remains_at_top) ? 'remains_at_top' : ''}}\" style=\"background-color: #{{bar.background_color}}; color: #{{bar.text_color}}; font-family: {{bar.font}}; border-color: #{{bar.border_color}};\">\n<div id=\"hb_msg_container\">\n<span>\n  {{bar.message}}\n  <input id=\"hb_email\" type=\"email\" placeholder=\"Your Email\"/>\n  <input id=\"hb_name\" type=\"text\" placeholder=\"Your Name\" {{HB.t(bar.settings.collect_names) ? \"\" : \"style='display:none'\"}}/>\n</span>\n<a onclick=\"window.parent.HB.submitEmail(document.getElementById('hb_email'), document.getElementById('hb_name'), document.getElementById('hb_msg_container')); return false\" href=\"#\" class=\"hellobar_cta hb-{{bar.link_style}}\" style=\"color: #{{bar.link_color}}; background-color: #{{bar.button_color}}; border-color: #{{bar.button_color}}\">\n  {{bar.link_text}}\n</a>\n</div>\n  <a href=\"http://www.hellobar.com/?utm_medium=hellobar&utm_campaign=HBlogo\" target=\"_parent\" class=\"hellobar_logo\"><img src=\"https://s3.amazonaws.com/hb-assets/logo_white.png\" alt=\"Hello Bar\" /></a>\n  <a href=\"#\" class=\"hellobar_arrow\" style=\"{{HB.t(bar.closable) ? '' : 'display:none'}}\"><img src=\"https://s3.amazonaws.com/hb-assets/arrow_white.png\" alt=\"\" /></a>\n  <div id=\"hellobar-shadow\"></div>\n</div>\n");
    HB.setTemplate("social/tweet_on_twitter", "<div id=\"hellobar\" class=\"{{bar.size}} {{bar.tab_side}} {{HB.t(bar.show_border) ? 'has_border' : ''}} {{HB.t(bar.remains_at_top) ? 'remains_at_top' : ''}}\" style=\"background-color: #{{bar.background_color}}; color: #{{bar.text_color}}; font-family: {{bar.font}}; border-color: #{{bar.border_color}};\">\n<span>\n  {{bar.message}}\n</span>\n\n<span class=\"social-wrapper twitter-share-button-wrapper\">\n  <a href=\"https://twitter.com/share\" class=\"twitter-share-button\" data-lang=\"en\" data-text=\"{{bar.settings.message_to_tweet}}\" data-url=\"{{HB.t(bar.settings.use_location_for_url) ? window.parent.location.href : bar.settings.url_to_tweet}}\"></a>\n</span>\n\n<script>\n  !function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=\"https://platform.twitter.com/widgets.js\";fjs.parentNode.insertBefore(js,fjs);}}(document,\"script\",\"twitter-wjs\");\n\n  function attachTrackingEvents() {\n    if (typeof(twttr) == 'undefined') {\n      setTimeout(attachTrackingEvents, 100);\n    } else {\n      twttr.ready(function (twttr) {\n        if (parent.HB) {twttr.events.bind('click', parent.HB.goalPerformed);}\n      });\n    }\n  };\n\n  attachTrackingEvents();\n</script>\n  <a href=\"http://www.hellobar.com/?utm_medium=hellobar&utm_campaign=HBlogo\" target=\"_parent\" class=\"hellobar_logo\"><img src=\"https://s3.amazonaws.com/hb-assets/logo_white.png\" alt=\"Hello Bar\" /></a>\n  <a href=\"#\" class=\"hellobar_arrow\" style=\"{{HB.t(bar.closable) ? '' : 'display:none'}}\"><img src=\"https://s3.amazonaws.com/hb-assets/arrow_white.png\" alt=\"\" /></a>\n  <div id=\"hellobar-shadow\"></div>\n</div>\n");
    HB.setTemplate("social/follow_on_twitter", "<div id=\"hellobar\" class=\"{{bar.size}} {{bar.tab_side}} {{HB.t(bar.show_border) ? 'has_border' : ''}} {{HB.t(bar.remains_at_top) ? 'remains_at_top' : ''}}\" style=\"background-color: #{{bar.background_color}}; color: #{{bar.text_color}}; font-family: {{bar.font}}; border-color: #{{bar.border_color}};\">\n<span>\n  {{bar.message}}\n</span>\n\n<span class=\"social-wrapper twitter-follow-button-wrapper\">\n  <a href=\"https://twitter.com/{{bar.settings.twitter_handle}}\" class=\"twitter-follow-button\" data-show-count=\"false\" data-lang=\"en\"></a>\n</span>\n\n<script>\n  !function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=\"https://platform.twitter.com/widgets.js\";fjs.parentNode.insertBefore(js,fjs);}}(document,\"script\",\"twitter-wjs\");\n\n  function attachTrackingEvents() {\n    if (typeof(twttr) == 'undefined') {\n      setTimeout(attachTrackingEvents, 100);\n    } else {\n      twttr.ready(function (twttr) {\n        if (parent.HB) {twttr.events.bind('click', parent.HB.goalPerformed);}\n      });\n    }\n  };\n\n  attachTrackingEvents();\n</script>\n  <a href=\"http://www.hellobar.com/?utm_medium=hellobar&utm_campaign=HBlogo\" target=\"_parent\" class=\"hellobar_logo\"><img src=\"https://s3.amazonaws.com/hb-assets/logo_white.png\" alt=\"Hello Bar\" /></a>\n  <a href=\"#\" class=\"hellobar_arrow\" style=\"{{HB.t(bar.closable) ? '' : 'display:none'}}\"><img src=\"https://s3.amazonaws.com/hb-assets/arrow_white.png\" alt=\"\" /></a>\n  <div id=\"hellobar-shadow\"></div>\n</div>\n");
    HB.setTemplate("social/like_on_facebook", "<div id=\"hellobar\" class=\"{{bar.size}} {{bar.tab_side}} {{HB.t(bar.show_border) ? 'has_border' : ''}} {{HB.t(bar.remains_at_top) ? 'remains_at_top' : ''}}\" style=\"background-color: #{{bar.background_color}}; color: #{{bar.text_color}}; font-family: {{bar.font}}; border-color: #{{bar.border_color}};\">\n<span>\n  {{bar.message}}\n</span>\n\n<script>\n  (function(d, s, id) {\n    var js, fjs = d.getElementsByTagName(s)[0];\n    if (d.getElementById(id)) return;\n    js = d.createElement(s); js.id = id;\n    js.src = \"//connect.facebook.net/en_US/all.js#xfbml=1\";\n    fjs.parentNode.insertBefore(js, fjs);\n  }(document, 'script', 'facebook-jssdk'));\n\n  window.fbAsyncInit = function() {\n    FB.Event.subscribe('edge.create', function(response) {\n      parent.HB.goalPerformed();\n    });\n  };\n</script>\n\n<span class=\"social-wrapper fb-like-wrapper\">\n  <span class=\"fb-like\" data-href=\"{{(HB.t(bar.settings.use_location_for_url) ? window.parent.location.href : bar.settings.url_to_like).replace(/^(?!http)/, 'http://')}}\" data-layout=\"button_count\" data-action=\"like\" data-show-faces=\"false\" data-share=\"false\"></span>\n</span>\n\n<span id=\"fb-root\"></span>\n  <a href=\"http://www.hellobar.com/?utm_medium=hellobar&utm_campaign=HBlogo\" target=\"_parent\" class=\"hellobar_logo\"><img src=\"https://s3.amazonaws.com/hb-assets/logo_white.png\" alt=\"Hello Bar\" /></a>\n  <a href=\"#\" class=\"hellobar_arrow\" style=\"{{HB.t(bar.closable) ? '' : 'display:none'}}\"><img src=\"https://s3.amazonaws.com/hb-assets/arrow_white.png\" alt=\"\" /></a>\n  <div id=\"hellobar-shadow\"></div>\n</div>\n");
    HB.setTemplate("social/share_on_linkedin", "<div id=\"hellobar\" class=\"{{bar.size}} {{bar.tab_side}} {{HB.t(bar.show_border) ? 'has_border' : ''}} {{HB.t(bar.remains_at_top) ? 'remains_at_top' : ''}}\" style=\"background-color: #{{bar.background_color}}; color: #{{bar.text_color}}; font-family: {{bar.font}}; border-color: #{{bar.border_color}};\">\n<span>\n  {{bar.message}}\n</span>\n\n<span class=\"social-wrapper linkedin-button-wrapper\">\n  <span class=\"linkedin-button\">\n    <script src=\"//platform.linkedin.com/in.js\" type=\"text/javascript\">lang: en_US</script>\n    <script type=\"IN/Share\" data-url=\"{{(HB.t(bar.settings.use_location_for_url) ? window.parent.location.href : bar.settings.url_to_share).replace(/^(?!http)/, 'http://')}}\" data-counter=\"right\" data-showzero=\"true\"></script>\n  </span>\n</span>\n\n<script>\n  function trackClick(event) {\n    var target = event.target || event.srcElement;\n\n    if (target.innerHTML == 'Share') {\n      parent.HB.goalPerformed();\n    }\n  }\n\n  if (document.addEventListener) {\n    document.addEventListener('click', trackClick, true);\n  } else if (document.attachEvent) {\n    document.attachEvent('onclick', trackClick);\n  }\n</script>\n  <a href=\"http://www.hellobar.com/?utm_medium=hellobar&utm_campaign=HBlogo\" target=\"_parent\" class=\"hellobar_logo\"><img src=\"https://s3.amazonaws.com/hb-assets/logo_white.png\" alt=\"Hello Bar\" /></a>\n  <a href=\"#\" class=\"hellobar_arrow\" style=\"{{HB.t(bar.closable) ? '' : 'display:none'}}\"><img src=\"https://s3.amazonaws.com/hb-assets/arrow_white.png\" alt=\"\" /></a>\n  <div id=\"hellobar-shadow\"></div>\n</div>\n");
    HB.setTemplate("social/plus_one_on_google_plus", "<div id=\"hellobar\" class=\"{{bar.size}} {{bar.tab_side}} {{HB.t(bar.show_border) ? 'has_border' : ''}} {{HB.t(bar.remains_at_top) ? 'remains_at_top' : ''}}\" style=\"background-color: #{{bar.background_color}}; color: #{{bar.text_color}}; font-family: {{bar.font}}; border-color: #{{bar.border_color}};\">\n<span>\n  {{bar.message}}\n</span>\n\n<span class=\"social-wrapper g-plusone-wrapper\">\n  <span class=\"g-plusone\" data-href=\"{{(HB.t(bar.settings.use_location_for_url) ? window.parent.location.href : bar.settings.url_to_plus_one).replace(/^(?!http)/, 'http://')}}\" data-callback=\"trackPlusOne\" data-recommendations=\"false\"></span>\n</span>\n\n<script>\n  function trackPlusOne(param) {\n    parent.HB.goalPerformed();\n  }\n</script>\n\n<script type=\"text/javascript\" src=\"https://apis.google.com/js/plusone.js\"></script>\n  <a href=\"http://www.hellobar.com/?utm_medium=hellobar&utm_campaign=HBlogo\" target=\"_parent\" class=\"hellobar_logo\"><img src=\"https://s3.amazonaws.com/hb-assets/logo_white.png\" alt=\"Hello Bar\" /></a>\n  <a href=\"#\" class=\"hellobar_arrow\" style=\"{{HB.t(bar.closable) ? '' : 'display:none'}}\"><img src=\"https://s3.amazonaws.com/hb-assets/arrow_white.png\" alt=\"\" /></a>\n  <div id=\"hellobar-shadow\"></div>\n</div>\n");
    HB.setTemplate("social/pin_on_pinterest", "<div id=\"hellobar\" class=\"{{bar.size}} {{bar.tab_side}} {{HB.t(bar.show_border) ? 'has_border' : ''}} {{HB.t(bar.remains_at_top) ? 'remains_at_top' : ''}}\" style=\"background-color: #{{bar.background_color}}; color: #{{bar.text_color}}; font-family: {{bar.font}}; border-color: #{{bar.border_color}};\">\n<span>\n  {{bar.message}}\n</span>\n\n<span class=\"social-wrapper pinterest-pin-button-wrapper\">\n  <span class=\"pinterest-pin-button\">\n    <a href=\"//www.pinterest.com/pin/create/button/?url={{encodeURIComponent(HB.t(bar.settings.use_location_for_url) ? window.parent.location.href : bar.settings.pinterest_url)}}&media={{encodeURIComponent(bar.settings.pinterest_image_url)}}&description={{encodeURIComponent(bar.settings.pinterest_description)}}\" target=\"_blank\" onclick=\"parent.HB.goalPerformed()\"><img src=\"//assets.pinterest.com/images/pidgets/pinit_fg_en_rect_gray_20.png\"/></a>\n  </span>\n</span>\n  <a href=\"http://www.hellobar.com/?utm_medium=hellobar&utm_campaign=HBlogo\" target=\"_parent\" class=\"hellobar_logo\"><img src=\"https://s3.amazonaws.com/hb-assets/logo_white.png\" alt=\"Hello Bar\" /></a>\n  <a href=\"#\" class=\"hellobar_arrow\" style=\"{{HB.t(bar.closable) ? '' : 'display:none'}}\"><img src=\"https://s3.amazonaws.com/hb-assets/arrow_white.png\" alt=\"\" /></a>\n  <div id=\"hellobar-shadow\"></div>\n</div>\n");
    HB.setTemplate("social/follow_on_pinterest", "<div id=\"hellobar\" class=\"{{bar.size}} {{bar.tab_side}} {{HB.t(bar.show_border) ? 'has_border' : ''}} {{HB.t(bar.remains_at_top) ? 'remains_at_top' : ''}}\" style=\"background-color: #{{bar.background_color}}; color: #{{bar.text_color}}; font-family: {{bar.font}}; border-color: #{{bar.border_color}};\">\n<span>\n  {{bar.message}}\n</span>\n\n<span class=\"social-wrapper pinterest-follow-button-wrapper\">\n  <span class=\"pinterest-follow-button\">\n    <a data-pin-do=\"buttonFollow\" href=\"{{bar.settings.pinterest_user_url.replace(/^(?!http)/, 'http://')}}\">{{bar.settings.pinterest_full_name}}</a>\n    <script type=\"text/javascript\" async src=\"//assets.pinterest.com/js/pinit.js\"></script>\n  </span>\n</span>\n\n<script>\n  function trackClick(event) {\n    var target = event.target || event.srcElement;\n\n    if (typeof(target.href) == 'string' && target.href.indexOf('pinterest.com') >= 0) {\n      parent.HB.goalPerformed()\n    }\n  }\n\n  if (document.addEventListener) {\n    document.addEventListener('click', trackClick, true);\n  } else if (document.attachEvent) {\n    document.attachEvent('onclick', trackClick);\n  }\n</script>\n  <a href=\"http://www.hellobar.com/?utm_medium=hellobar&utm_campaign=HBlogo\" target=\"_parent\" class=\"hellobar_logo\"><img src=\"https://s3.amazonaws.com/hb-assets/logo_white.png\" alt=\"Hello Bar\" /></a>\n  <a href=\"#\" class=\"hellobar_arrow\" style=\"{{HB.t(bar.closable) ? '' : 'display:none'}}\"><img src=\"https://s3.amazonaws.com/hb-assets/arrow_white.png\" alt=\"\" /></a>\n  <div id=\"hellobar-shadow\"></div>\n</div>\n");
    HB.setTemplate("social/share_on_buffer", "<div id=\"hellobar\" class=\"{{bar.size}} {{bar.tab_side}} {{HB.t(bar.show_border) ? 'has_border' : ''}} {{HB.t(bar.remains_at_top) ? 'remains_at_top' : ''}}\" style=\"background-color: #{{bar.background_color}}; color: #{{bar.text_color}}; font-family: {{bar.font}}; border-color: #{{bar.border_color}};\">\n<span>\n  {{bar.message}}\n</span>\n\n<span class=\"social-wrapper buffer-add-button-wrapper\">\n  <a href=\"http://bufferapp.com/add/?url={{encodeURIComponent((HB.t(bar.settings.use_location_for_url) ? window.parent.location.href : bar.settings.buffer_url).replace(/^(?!http)/, 'http://'))}}&text={{encodeURIComponent(bar.settings.buffer_message)}}\" class=\"buffer-add-button\" target=\"_blank\" onclick=\"window.parent.HB.trackClick(this)\"></a>\n</span>\n  <a href=\"http://www.hellobar.com/?utm_medium=hellobar&utm_campaign=HBlogo\" target=\"_parent\" class=\"hellobar_logo\"><img src=\"https://s3.amazonaws.com/hb-assets/logo_white.png\" alt=\"Hello Bar\" /></a>\n  <a href=\"#\" class=\"hellobar_arrow\" style=\"{{HB.t(bar.closable) ? '' : 'display:none'}}\"><img src=\"https://s3.amazonaws.com/hb-assets/arrow_white.png\" alt=\"\" /></a>\n  <div id=\"hellobar-shadow\"></div>\n</div>\n");

  HB.addCSS("#hellobar_pusher{height:30px;position:relative;overflow:hidden}#hellobar{min-height:30px;height:auto;text-align:center;width:100%;_width:expression(eval(document.body.offsetWidth-20));top:0;left:0;margin:0;padding:0;z-index:5000;position:absolute}#hellobar.has_border{border-bottom:3px solid white}#hellobar_pusher.large{height:50px}#hellobar.large{min-height:50px;height:auto;font-size:17px;font-weight:600}#hellobar.large span{font-size:17px}#hellobar.large a{line-height:45px}#hellobar.large a.hellobar_cta.hb-text{line-height:48px}#hellobar.large span{line-height:25px}#hellobar.large a.hellobar_logo{top:10px}#hellobar.large a.hellobar_logo img{height:29px;width:48px}#hellobar.large a.hellobar_arrow{top:10px}#hellobar.large a.hellobar_arrow img{height:29px;width:28px}#hellobar.large a.hellobar_cta.hb-button{padding:6px 15px}#hellobar.regular{font-size:14px}#hellobar.regular span{font-size:14px}#hellobar.regular a{line-height:30px}#hellobar.regular a.hellobar_cta.hb-text{line-height:28px}#hellobar.regular span{line-height:20px;margin-top:3px}#hellobar.regular a.hellobar_logo{top:4px}#hellobar.regular a.hellobar_logo img{height:21px;width:33px}#hellobar.regular a.hellobar_arrow{top:4px}#hellobar.regular a.hellobar_arrow img{height:21px;width:21px}#hellobar.regular a.hellobar_cta.hb-button{padding:2px 8px}#hellobar{white-space:normal}#hellobar span{margin-left:50px;margin-right:20px;margin-top:13px;display:inline-block}#hellobar a{margin-right:30px}#hellobar.large span{margin-left:65px}#hellobar.large.mobile span,#hellobar.regular.mobile span{margin-left:10px}#hellobar.large a{margin-right:65px}#hellobar a.hellobar_cta.hb-text{padding:6px 15px;border-radius:4px;color:#fff;padding-left:5px;text-decoration:underline;background:none!important}#hellobar a:hover.hellobar_cta.hb-text{}#hellobar a img{border:none;padding:0;margin:0;background-color:transparent}#hellobar a.hellobar_cta.hb-button{border:1px solid;box-shadow:inset 0 1px 1px rgba(255,255,255,0.1);border-radius:4px;margin:0;margin-left:10px;text-decoration:none;color:#fff;white-space:nowrap}#hellobar.mobile a.hellobar_logo{display:none}#hellobar.mobile a.hellobar_arrow{display:none}#hellobar a.hellobar_logo{position:absolute;display:block;left:10px;right:auto;opacity:.3}#hellobar a.hellobar_arrow{display:block;position:absolute;right:10px;left:auto;opacity:.3}#hellobar.left a.hellobar_logo{right:10px;left:auto}#hellobar.left a.hellobar_arrow{left:10px;right:auto}a:hover.hellobar_logo,a:hover.hellobar_arrow{opacity:.6}#hellobar-shadow{left:0;width:100%;height:8px;line-height:8px;background:url(https://s3.amazonaws.com/hb-assets/system/modules/hellobar/lib/sprite-8bit.png);position:absolute;margin-top:-3px;display:none}#hellobar.has_border #hellobar-shadow{margin-top:0}#hellobar input{box-shadow:inset 1px 1px 3px #aaa;border-radius:4px;border:none;width:150px;margin-left:10px;vertical-align:middle;padding:3px 3px;margin-bottom:2px;margin-top:0}#hellobar.large input{padding:5px 5px;margin-bottom:5px;margin-top:0}#hellobar iframe{vertical-align:middle}#hellobar.large span.social-wrapper{white-space:nowrap;margin:0}#hellobar.large span.twitter-share-button-wrapper{width:110px}#hellobar.large span.twitter-follow-button-wrapper{width:130px}#hellobar.large span.fb-like-wrapper{width:80px}#hellobar.large span.linkedin-button-wrapper{width:105px}#hellobar.large span.g-plusone-wrapper{width:110px}#hellobar.large span.pinterest-pin-button-wrapper{width:50px}#hellobar.large span.pinterest-follow-button-wrapper{width:100px}#hellobar span.fb_iframe_widget,#hellobar span.fb_iframe_widget span{margin:0;overflow:hidden}#hellobar span.fb_iframe_widget{position:relative;top:4px}#hellobar span.linkedin-button{line-height:normal;position:relative;top:5px;margin:0}#hellobar span.linkedin-button span{line-height:normal;margin:0;font-size:100%}#hellobar div#___plusone_0,#hellobar div#___follow_0{vertical-align:middle!important}#hellobar span.pinterest-pin-button{position:relative;top:5px;margin:0}#hellobar span.pinterest-pin-button a{margin:0}#hellobar span.pinterest-follow-button{position:relative;top:-2px;margin-left:0}#hellobar span.pinterest-follow-button a{display:none}#hellobar a.buffer-add-button{width:55px;height:20px;display:inline-block;overflow:hidden;background-image:url(https://d389zggrogs7qo.cloudfront.net/images/buffer_button.png);position:relative;top:4px;margin-right:0}#hellobar a.buffer-add-button:hover{background-position:0 -20px}.gc-bubbleDefault,.pls-container{display:none!important}#hellobar.multiline a.hellobar_cta.hb-button{margin-left:10px}#hellobar.mobile a.hellobar_cta.hb-button{margin-left:inherit}#hellobar.mobile #hb_email,#hellobar.mobile #hb_name{width:80%;margin-right:2.5%}#hellobar.mobile #hb_email{margin-top:10px}#hellobar\u003ediv{margin-right:58px}#hellobar.multiline\u003ediv{margin-right:65px}#hellobar.mobile\u003ediv{margin-right:inherit}");
