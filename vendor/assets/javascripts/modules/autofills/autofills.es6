hellobar.defineModule('autofills',
  ['hellobar', 'base.storage', 'base.dom', 'base.bus'],
  function (hellobar, storage, dom, bus) {
    ...
    return {
      ...
      initialize: function (configurator) {
        ...
        configuration.autoRun() && dom.runOnDocumentReady(function () {
          run();
          bus.on('hellobar.elements.viewed', elementViewedHandler);
        });
      },
