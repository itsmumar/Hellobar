hellobar.defineModule('elements.rules', ['base.format'], function (format) {

  // TODO do something with HB.nowInTimezone, HB.shouldShowElement (elements.visibility), HB.getSegmentValue and other HB usages

  // TODO make it work like a pure function: permittedElements = elementsRules.applyRules(allElements);
  ...
  function addRule(matchType, conditions, siteElements) {
