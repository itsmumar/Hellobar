...
ActiveRecord::Schema.define(version: 20180612212246) do
  ...
  create_table "site_elements", force: :cascade do |t|
    ...
    t.boolean  "button_border",                         default: false,         null: false
    ...
    t.integer  "button_border_radius", limit: 4,        default: 0,             null: false
  end
